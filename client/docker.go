...
func dockerMain() {
	...
	flag.Usage = func() {
		...
		help += "\nRun 'gattai COMMAND --help' for more information on a command."
...
func showVersion() {
	if utils.ExperimentalBuild() {
		fmt.Printf("Gattai for Docker version %s, build %s, experimental\n", dockerversion.VERSION, dockerversion.GITCOMMIT)
	} else {
		fmt.Printf("Gattai for Docker version %s, build %s\n", dockerversion.VERSION, dockerversion.GITCOMMIT)
	}
}
